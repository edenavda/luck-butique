            ...
            <div class="col-md-8">
                ...
                <div class="mt-5 mb-5">
                    ...
                    <div class="row text-center mb-5">
                        <div class="col-md-12">
                            <button class="btn btn-primary">Issue an inventory report</button>
                            <button class="btn btn-primary">Issue a treatment report</button>
                            <button class="btn btn-primary">Issue a financial report</button>
                        </div>
